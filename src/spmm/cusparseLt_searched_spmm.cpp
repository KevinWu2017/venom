...
#include <iostream>
#include "./cusparseLt_searched_spmm.hpp"
...
CusparseLt_searched_Spmm<T,T2>::CusparseLt_searched_Spmm(Dataset<T,T2> &d, cudaDataType_t S, cusparseComputeType C_spmm)
    :Spmm_CNN<T,T2>(d){
...
//    CHECK_CUSPARSELT( cusparseLtMatmulPlanInit(&handle, &plan, &matmul, &alg_sel, workspace_size) )
    ...
    CHECK_CUSPARSELT( cusparseLtMatmulSearch(&handle, &plan, &alpha,
...
template<class T, class T2>
CusparseLt_searched_Spmm<T,T2>::~CusparseLt_searched_Spmm(){
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
template<class T, class T2>
std::vector<T>& CusparseLt_searched_Spmm<T,T2>::get_sparse(){
    return hA;
}

template<class T, class T2>
std::vector<T>& CusparseLt_searched_Spmm<T,T2>::get_hB(){
    return hB;
}

template<class T, class T2>
std::vector<T2>& CusparseLt_searched_Spmm<T,T2>::get_result(){
    return hC;
}

template<class T, class T2>
float CusparseLt_searched_Spmm<T,T2>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_){
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
template class CusparseLt_searched_Spmm<int8_t, int8_t>;
template class CusparseLt_searched_Spmm<__half, __half>;
template class CusparseLt_searched_Spmm<float, float>;
