...
#ifndef CUSPARSELT_SEARCHED_SPMM_H
#define CUSPARSELT_SEARCHED_SPMM_H
...
class CusparseLt_searched_Spmm: public Spmm_CNN<T,T2> {
    public:
        // Empty virtual destructor for proper cleanup
        ~CusparseLt_searched_Spmm();
        CusparseLt_searched_Spmm(Dataset<T,T2> &d, cudaDataType_t S, cusparseComputeType C_spmm);
